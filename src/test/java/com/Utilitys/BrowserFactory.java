...
public class BrowserFactory
		...
		public static WebDriver startBrowser(String browserName)throws MalformedURLException
		{
			...
			if (browserName.equalsIgnoreCase("firefox"))
			{
				...
				try {
				    ...
				    capabilities.setCapability(GeckoDriverService.GECKO_DRIVER_EXE_PROPERTY,System.setProperty("webdriver.firefox.marionette",DataProviderFactory.getConfig().getFireFoxGekoPath()));
 ...
 try {
	//System.setProperty("webdriver.edge.driver", "C:\\Users\\preetish\\Downloads\\Compressed\\MicrosoftWebDriver.exe");
		...
		driver1=new RemoteWebDriver(new URL("http://192.168.1.15:4444/wd/hub"), cap);
